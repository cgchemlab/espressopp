...
// ESPP_CLASS
#ifndef _INTERACTION_LENNARDJONESUNIQUE_HPP
#define _INTERACTION_LENNARDJONESUNIQUE_HPP
...
namespace espressopp {
  namespace interaction {
    ...
    */
    class LennardJonesUnique : public PotentialTemplate< LennardJonesUnique > {
    private:
      real epsilon;
      real sigma;
      real ff1, ff2;
	...
	: epsilon(0.0), sigma(0.0) {
      ...
      LennardJonesUnique(real _epsilon, real _sigma, 
    ...
    struct LennardJonesUnique_pickle : boost::python::pickle_suite
    {
      static
      boost::python::tuple
      getinitargs(LennardJonesUnique const& pot)
      {
    	  real eps;
          real sig;
          real rc;
