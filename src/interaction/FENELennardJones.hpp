  ...
  namespace interaction {
    ...
    */
    ...
    public:
      ...
      FENELennardJones()
        : K(0.0), r0(0.0), rMax(0.0), sigma(0.0), epsilon(0.0) {
        setShift(0.0);
        setCutoff(infinity);
        preset();
      }

      FENELennardJones(real _K, real _r0, real _rMax, 
		   real _sigma, real _epsilon, real _cutoff, real _shift)
      ...
      FENELennardJones(real _K, real _r0, real _rMax, real _sigma, real _epsilon,
		   real _cutoff)
        : K(_K), r0(_r0), rMax(_rMax), sigma(_sigma), epsilon(_epsilon) {
        autoShift = false;
        setCutoff(_cutoff);
      ...
      real _computeEnergySqrRaw(real distSqr) const {
        ...
        real energyLJ = 4.0 * epsilon * (frac6 * frac6 - frac6);
        return energy + energyLJ;
      }
