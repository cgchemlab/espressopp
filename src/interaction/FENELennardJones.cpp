...
//////////////////////////////////////////////////
void FENELennardJones::registerPython() {
  using namespace espressopp::python;
  class_<FENELennardJones, bases<Potential> >("interaction_FENELennardJones",
  ...
  class_<FixedPairListFENELennardJones, bases<Interaction> >(
      "interaction_FixedPairListFENELennardJones",
      init<shared_ptr<System>, shared_ptr<FixedPairList>, shared_ptr<FENELennardJones> >())
      .def(init<shared_ptr<System>, shared_ptr<FixedPairListAdress>,
                shared_ptr<FENELennardJones> >())
