...
// ESPP_CLASS
#ifndef _STORAGE_DOMAINDECOMPOSITIONFREE_HPP
#define _STORAGE_DOMAINDECOMPOSITIONFREE_HPP
...
class DomainDecompositionFree: public Storage {
 public:
  DomainDecompositionFree(shared_ptr<System> system,
                          const Int3D &_nodeGrid,
                          const Int3D &_cellGrid);

  virtual ~DomainDecompositionFree() {}
